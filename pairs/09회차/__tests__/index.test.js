...
//     });
//     test('0.1*0.2 는 0.02이다', () => {
//       expect(Calculator('0.1*0.2')).toBe(0.02);
//     });
...
//     });
//     test('1*2+3 는 5이다', () => {
//       expect(Calculator('1*2+3')).toBe(5);
//     });
//     test('1/2-3 는 -2.5이다', () => {
  ...
  beforeEach(() => {
    ...
    <div id="root">
      ...
      <div class="display">
        ...
        <!-- 임시결과창 -->
        <div class="display-output">123</div>
      </div>
      <!-- 키패드 -->
      <div class='keypad'>
        <!--  -->
