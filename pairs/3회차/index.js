const putComma = target => {
  const num = +target;
  if (isNaN(num)) alert(new Error('숫자가 아닙니다.').message);
  return num.toLocaleString('ko-kr');
};

console.log(putComma(1000));
console.log(putComma('0010'));
console.log(putComma('1000000000000'));
console.log(putComma('일1000000000000'));
console.log(putComma('100000삼0000000'));
console.log(putComma('1000000000000팔'));
